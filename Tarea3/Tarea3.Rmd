...
```
Podemos observar que estos resultados son los esperados de acuerdo con la teoría. En este caso al ser un grafo relativamente pequeño el sumatorio de $n=(0,\infty)$ no es necesario, pues las puntuaciones de NK y HITS convergen con un sumatorio de $n=(0,7)$
$$
