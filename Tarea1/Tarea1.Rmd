...
El diámetro de un grafo es la mayor distancia entre todos los pares de puntos de la misma. A continuación se obtiene el listado de vértices del diametro del grafo y se representa un gráfico con el camino del mismo.
